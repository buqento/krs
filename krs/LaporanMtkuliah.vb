...
Public Class LaporanMtkuliah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "krs.LaporanMtkuliah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanMtkuliah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanMtkuliah = New LaporanMtkuliah()
        rpt.Site = Me.Site
        Return rpt
    End Function
